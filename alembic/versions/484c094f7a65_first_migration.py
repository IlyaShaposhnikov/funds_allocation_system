...
Revision ID: 484c094f7a65
Revises: 
Create Date: 2025-06-18 22:12:27.653777
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount > 0', name='full_amount_check'),
    sa.CheckConstraint('full_amount >= invested_amount', name='amounts_check'),
    sa.CheckConstraint('invested_amount >= 0', name='invested_amount_check'),
